...
//			add_action( 'woocommerce_after_customer_login_form', [ $this, 'woocommerce_account_container_end' ], 10 );
		...
		public function checkout_billing_fields( $fields ) {
			...
			$fields['billing_first_name']['placeholder']    = __( 'Enter your first name', 'freeplants' );
			...
			$fields['billing_last_name']['placeholder']     = __( 'Enter your last name', 'freeplants' );
			...
			$fields['billing_company']['placeholder']       = __( 'Enter your company name', 'freeplants' );
			...
			$fields['billing_city']['placeholder']          = __( 'Enter your town/city', 'freeplants' );
			...
			$fields['billing_postcode']['placeholder']      = __( 'Enter your postcode', 'freeplants' );
			...
			$fields['billing_state']['placeholder']         = __( 'Enter your county', 'freeplants' );
			...
			$fields['billing_phone']['placeholder']         = __( 'Enter your phone no.', 'freeplants' );
			...
			$fields['billing_email']['placeholder']         = __( 'Enter your email address', 'freeplants' );
			...
			$fields['billing_country']['placeholder']       = __( 'Select your country', 'freeplants' );
		...
		public function checkout_shipping_fields( $fields ) {
			...
			$fields['shipping_first_name']['placeholder']   = __( 'Enter your first name', 'freeplants' );
			...
			$fields['shipping_last_name']['placeholder']    = __( 'Enter your last name', 'freeplants' );
			...
			$fields['shipping_company']['placeholder']      = __( 'Enter your company name', 'freeplants' );
			...
			$fields['shipping_city']['placeholder']         = __( 'Enter your town/city', 'freeplants' );
			...
			$fields['shipping_postcode']['placeholder']     = __( 'Enter your postcode', 'freeplants' );
			...
			$fields['shipping_state']['placeholder']        = __( 'Enter your county', 'freeplants' );
			...
			$fields['shipping_country']['placeholder']      = __( 'Select your country', 'freeplants' );
