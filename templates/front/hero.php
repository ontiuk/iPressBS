...
$ip_hero_button_text = get_theme_mod( 'ipress_hero_button_text', __( 'Learn More', 'ipress-child' ) );

// Background image
$ip_hero_image = IPR_Settings::hero_image();
$ip_hero_image = ( false !== $ip_hero_image ) ? $ip_hero_image : sprintf( '<img src="%s" alt="%s" />', esc_url( IPRESS_CHILD_IMAGES_URL . '/hero.svg' ), esc_attr( $ip_hero_title ) );
